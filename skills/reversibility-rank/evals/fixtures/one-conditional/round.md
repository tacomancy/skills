...
1. Give every note a sequential integer id in the SQLite table. Today it is assigned at insert, referenced nowhere else, and renumbered freely on rebuild; the sync feature scheduled for next quarter will use it as the cross-device key.
